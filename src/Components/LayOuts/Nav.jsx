...
const Nav = () => {
  ...
  const link = (
    <>
      ...
      <ul className="relative z-40 menu menu-horizontal p-0 m-0">
        <li className="relative group">
          <NavLink className="text-base text-red-600 font-bold" to="/items">
            Accessories Iteam
          </NavLink>

          {/* Dropdown */}
          <ul className="absolute left-0 top-full hidden group-hover:block bg-white text-black mt-1 p-2 shadow-lg rounded w-40  mx-auto">
            <a className="block px-4 py-2 hover:bg-gray-200 font-semibold  border-b-2">Dog Helth care </a>
            <a className="block px-4 py-2 hover:bg-gray-200 font-semibold whitespace-break-spaces">Cat Food & Accessories</a>
          </ul>
        </li>
      </ul>
      <li className="text-base text-red-600 font-bold">
  ...
  return (
    <div className="navbar px-8 w-full fixed top-20 left-0 z-30 bg-base-100 shadow-md">
      ...
      <div className="navbar-end gap-2">
        ...
        {user ? (
          ...
          <Link
            className="bg-slate-400 px-2 py-2 rounded-md text-black font-medium"
            to="/login"
            onClick={logOuts}
          >
            Login
        ...
        <div className=" drawer-end p-3 rounded-full shadow-md bg-gray-200">
          ...
          <div className="drawer-side">
            ...
            <div className="menu items-center bg-base-200 text-base-content min-h-full w-56 p-10">
              ...
              <h1 className="text-2xl text-red-500 whitespace-nowrap">
                No data Showing
              </h1>
            </div>
          </div>
