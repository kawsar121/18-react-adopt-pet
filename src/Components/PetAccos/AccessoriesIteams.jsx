      ...
      <div className="grid justify-center md:grid-cols-3 lg:grid-cols-4 gap-10 mt-10">
        {tem.map((dataload) => (
          ...
          <div className="absolute top-8 right-[7px] flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition duration-300">
            <Link to="/success" className="w-9 h-9 bg-white border-2 rounded-full flex items-center justify-center">
              <svg
                width="14"
                height="12"
                viewBox="0 0 14 12"
            ...
            <span className="line-through text-gray-500 mr-2">{dataload.price}</span>
            <span className="text-md font-bold text-black">{dataload.price}</span>
            </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg w-96 shadow-lg relative">
            ...
            <h2 className="text-xl font-semibold mb-3">
              {selectedItem.accessories_name}
            </h2>
            <img
              src={selectedItem.accessories_image}
              alt="modal-img"
              className="rounded-lg mb-3 w-64 mx-auto"
            />
            <p className="text-gray-700 mb-2">
              Discount: {selectedItem.discount_price}
            </p>
            <p className="text-gray-700 mb-4">
              Price: {selectedItem.price} BDT
            </p>
